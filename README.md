...
本目录是 Quartus Prime Lite 下的 8 位微程序 CPU 实验工程整理。重点工程是 2026 年 6 月修改过的四个 f4b 版本：
...
根目录中 2025 年修改日期的文件大多是老师给的原始资料，例如 `如何做f4b.doc`、`源代码.txt`、`RTL视图.png`、`程序1仿真波形.png`、`程序2仿真波形.png`、`f4b.zip`。2026 年 6 月的工程和分析文件是本次整理的重点。
